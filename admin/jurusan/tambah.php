...
if(isset($_POST['submit'])) {
   $id    = uuid();
   $nama  = $_POST['nama'];
   $query = mysqli_query($conn, "INSERT INTO jurusan VALUES ('$id', '$nama')");
         ...
         <div class="card-body">
            <form action="" method="POST">
               <div class="form-group">
                  <label>Nama :</label>
                  <textarea name="nama" id="nama" class="form-control" placeholder="Masukan nama Program Studi" style="resize:none;" minlength="5" required></textarea>
               </div>
